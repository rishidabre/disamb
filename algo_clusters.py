...
path_authors=""
path_paperauthoraffil=""
path_paperreferences=""
...
if __name__=='__main__':
    ...
    if len(sys.argv)!=4:
        print "Usage: %s <authors_file> <papers_file> <references_file>"%sys.argv[0]
        quit()

    # Set the file paths
    path_authors=sys.argv[1]#"/home/neo4j/data/extracted/Authors/AuthorsTrimmed.txt"
    path_paperauthoraffil=sys.argv[2]#"/home/neo4j/data/extracted/PaperAuthorAffiliations/PaperAuthorAffiliations.txt"
    path_paperreferences=sys.argv[3]#"/home/neo4j/data/extracted/PaperReferences/PaperReferences.txt"

    try:
        f=open(path_authors,'r')
        f.close()
        f=open(path_paperauthoraffil,'r')
        f.close()
        f=open(path_paperreferences,'r')
        f.close()
    except Exception as e:
